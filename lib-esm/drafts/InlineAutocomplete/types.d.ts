...
export declare type ShowSuggestionsEvent = {
    /** The trigger that caused this query. */
    trigger: Trigger;
    /** The query string. */
    query: string;
};
export declare type Suggestion = string | {
    /**
...
export declare type Suggestions = Array<Suggestion> | 'loading';
export declare type TextInputElement = HTMLInputElement | HTMLTextAreaElement;
export declare type TextInputCompatibleChild = React.ReactElement<JSX.IntrinsicElements['textarea'] | JSX.IntrinsicElements['input']> & React.RefAttributes<HTMLInputElement & HTMLTextAreaElement>;
