...
export declare type CallbackCancelledResult = typeof callbackCancelledResult;
/**
 ...
 */
export declare const useSafeAsyncCallback: <A extends unknown[], R>(fn: (...args: A) => R, allowCallingAfterUnmount?: boolean) => (...args: A) => typeof callbackCancelledResult | R;
