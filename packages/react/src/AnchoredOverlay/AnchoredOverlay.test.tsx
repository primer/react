...
describe('AnchoredOverlay CSS anchor positioning behavior', () => {
  describe('when the browser supports native CSS anchor positioning', () => {
    it('should render overlay as visible immediately', () => {
      const {baseElement} = render(<AnchoredOverlayTestComponent initiallyOpen={true} />)
    ...
    it('should apply AnchoredOverlay class to overlay', () => {
      const {baseElement} = render(<AnchoredOverlayTestComponent initiallyOpen={true} />)
    ...
    it('should set data-anchor-position attribute', () => {
      const {baseElement} = render(<AnchoredOverlayTestComponent initiallyOpen={true} />)
    ...
    it('should set popover="manual" on overlay when renderAs is "popover"', () => {
      const {baseElement} = render(<AnchoredOverlayTestComponent initiallyOpen={true} renderAs="popover" />)
    ...
    it('should not set popover attribute on overlay when renderAs is "portal"', () => {
      const {baseElement} = render(<AnchoredOverlayTestComponent initiallyOpen={true} renderAs="portal" />)
    ...
    describe('when overlayProps.portalContainerName is provided', () => {
      it('should fall back to JS positioning (data-anchor-position="false")', () => {
