...
function Visual({children}: VisualProps) {
  return <span className={classes.BlankslateVisual}>{children}</span>
}
...
function Heading({as = 'h2', children}: HeadingProps) {
  return (
    <Box as={as} className={classes.BlankslateHeading}>
      {children}
    </Box>
  )
}
...
function Description({children}: DescriptionProps) {
  return <p className={classes.BlankslateDescription}>{children}</p>
}
...
function PrimaryAction({children, href}: PrimaryActionProps) {
  return (
    <div className={classes.BlankslateAction}>
