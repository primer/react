...
export type StyledSubNavProps = React.ComponentProps<'nav'> & {
 ...
 */
export const SubNav = React.forwardRef<HTMLElement, StyledSubNavProps>(function SubNav(
...
export const StyledSubNavLinks = toggleStyledComponent(
  CSS_MODULES_FEATURE_FLAG,
  'div',
 ...
 */
export const SubNavLinks = React.forwardRef<HTMLElement, StyledSubNavLinksProps>(function SubNavLink(
 ...
 * @primerparentid sub_nav
 */
export const SubNavLink = React.forwardRef<HTMLElement, StyledSubNavLinkProps>(function SubNavLink(
  {children, className, ...rest},
  forwardRef,
) {
  const enabled = useFeatureFlag(CSS_MODULES_FEATURE_FLAG)
