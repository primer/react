const colors = {
  ...
  prettylights: {
    syntax: {
      ...
      variable: 'var(--prettylights-syntax-variable, var(--color-prettylights-syntax-variable, #ffa198))',
      ...
      markupChangedText:
        'var(--prettylights-syntax-markupChanged-text, var(--color-prettylights-syntax-markup-changed-text, #ffdcd7))',
      markupChangedBg:
        'var(--prettylights-syntax-markupChanged-bg, var(--color-prettylights-syntax-markup-changed-bg, #67060c))',
      markupIgnoredText:
