const colors = {
  ...
  prettylights: {
    syntax: {
      ...
      entityTag: 'var(--prettylights-syntax-entityTag, var(--color-prettylights-syntax-entity-tag, #0550ae))',
      ...
      variable: 'var(--prettylights-syntax-variable, var(--color-prettylights-syntax-variable, #a40e26))',
      ...
      stringRegexp: 'var(--prettylights-syntax-stringRegexp, var(--color-prettylights-syntax-string-regexp, #0550ae))',
      ...
      markupInsertedText:
        'var(--prettylights-syntax-markupInserted-text, var(--color-prettylights-syntax-markup-inserted-text, #0550ae))',
      markupInsertedBg:
        'var(--prettylights-syntax-markupInserted-bg, var(--color-prettylights-syntax-markup-inserted-bg, #ddf4ff))',
      markupChangedText:
        'var(--prettylights-syntax-markupChanged-text, var(--color-prettylights-syntax-markup-changed-text, #a40e26))',
      markupChangedBg:
        'var(--prettylights-syntax-markupChanged-bg, var(--color-prettylights-syntax-markup-changed-bg, #ffcecb))',
      markupIgnoredText:
