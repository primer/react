const colors = {
  ...
  prettylights: {
    syntax: {
      ...
      keyword: 'var(--prettylights-syntax-keyword, var(--color-prettylights-syntax-keyword, #b35900))',
      string: 'var(--prettylights-syntax-string, var(--color-prettylights-syntax-string, #0a3069))',
      variable: 'var(--prettylights-syntax-variable, var(--color-prettylights-syntax-variable, #8a4600))',
      brackethighlighterUnmatched:
        'var(--prettylights-syntax-bracketHighlighterUnmatched, var(--color-prettylights-syntax-brackethighlighter-unmatched, #6f3800))',
      invalidIllegalText:
        'var(--prettylights-syntax-invalidIllegal-text, var(--color-prettylights-syntax-invalid-illegal-text, #f6f8fa))',
      invalidIllegalBg:
        'var(--prettylights-syntax-invalidIllegal-bg, var(--color-prettylights-syntax-invalid-illegal-bg, #6f3800))',
      carriageReturnText:
        'var(--prettylights-syntax-carriageReturn-text, var(--color-prettylights-syntax-carriage-return-text, #f6f8fa))',
      carriageReturnBg:
        'var(--prettylights-syntax-carriageReturn-bg, var(--color-prettylights-syntax-carriage-return-bg, #b35900))',
      ...
      markupDeletedText:
        'var(--prettylights-syntax-markupDeleted-text, var(--color-prettylights-syntax-markup-deleted-text, #6f3800))',
      markupDeletedBg:
        'var(--prettylights-syntax-markupDeleted-bg, var(--color-prettylights-syntax-markup-deleted-bg, #fff5e8))',
      markupInsertedText:
      ...
      markupChangedText:
        'var(--prettylights-syntax-markupChanged-text, var(--color-prettylights-syntax-markup-changed-text, #8a4600))',
      markupChangedBg:
        'var(--prettylights-syntax-markupChanged-bg, var(--color-prettylights-syntax-markup-changed-bg, #ffddb0))',
      markupIgnoredText:
