...
export const EventState = () => (
  <Examples>
    ...
    <VariantSection label="Converted from draft">
      <Timeline aria-label="Issue timeline">
        {/* 'Converted from draft' has no ISSUE_TAXONOMY leaf (a draft-conversion verb the Issues catalog excludes); left untagged. */}
        <Timeline.Item>
          <Timeline.Badge>
...
export const EventDuplicates = () => (
  <Examples>
    ...
    <VariantSection label="Marked as canonical">
      <Timeline aria-label="Issue timeline">
        {/* 'Marked as canonical' has no ISSUE_TAXONOMY leaf (only 'marked_as_duplicate' exists); left untagged. */}
        <Timeline.Item>
          <Timeline.Badge>
            <Octicon icon={DuplicateIcon} />
          </Timeline.Badge>
    ...
    <VariantSection label="Unmarked as duplicate">
      <Timeline aria-label="Issue timeline">
        {/* 'Unmarked as duplicate' has no ISSUE_TAXONOMY leaf (only 'marked_as_duplicate' exists); left untagged. */}
        <Timeline.Item>
          <Timeline.Badge>
            <Octicon icon={DuplicateIcon} />
          </Timeline.Badge>
    ...
    <VariantSection label="Unmarked as canonical">
      <Timeline aria-label="Issue timeline">
        {/* 'Unmarked as canonical' has no ISSUE_TAXONOMY leaf (only 'marked_as_duplicate' exists); left untagged. */}
        <Timeline.Item>
          <Timeline.Badge>
            <Octicon icon={DuplicateIcon} />
          </Timeline.Badge>
...
export const EventLabels = () => (
  <Examples>
    ...
    <VariantSection label="Labels added and removed">
      <Timeline aria-label="Issue timeline">
        {/* 'Labels added and removed' is one row representing two events (labeled + unlabeled); a single row cannot carry two event types, so left untagged. */}
        <Timeline.Item>
          <Timeline.Badge>
            <Octicon icon={TagIcon} />
          </Timeline.Badge>
