...
> &
  ...
  (
    ...
    let ariaDescribedBy = React.isValidElement<TriggerPropsType>(child) ? child.props['aria-describedby'] : undefined
    if (type === 'description') {
      ariaDescribedBy = ariaDescribedBy ? `${ariaDescribedBy} ${tooltipId}` : tooltipId
    }
