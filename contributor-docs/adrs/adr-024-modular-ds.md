...
- Layer 2: Parts, presentational-style components that one combines with hooks to
  create components
...
components that result in adoption challenges and ecosystem fragmentation.
