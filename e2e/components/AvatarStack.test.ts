...
test.describe('AvatarStack', () => {
  for (const featureFlagOn of [true, false]) {
    test.describe(`Feature flag ${featureFlagOn ? 'enabled' : 'disabled'}`, () => {
          ...
          test.describe(theme, () => {
            test('default @vrt', async ({page}) => {
              ...
              expect(await page.screenshot()).toMatchSnapshot(
                `AvatarStack.Custom Size On Parent Responsive.${theme}.png`,
              )
            })
        ...
        for (const theme of themes) {
          test.describe(theme, () => {
            test('default @vrt', async ({page}) => {
              ...
              // Default state
              expect(await page.screenshot()).toMatchSnapshot(
                `AvatarStack.Custom Size On Children Responsive.${theme}.png`,
              )
            })
