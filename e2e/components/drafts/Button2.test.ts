    ...
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button--playground',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Danger', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--danger',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Default', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button--default',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Disabled', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--disabled',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Invisible', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--invisible',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Large', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--large',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Leading Visual', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--leading-visual',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Medium', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--medium',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Outline', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--outline',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Primary', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--primary',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Small', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--small',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Trailing Counter', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--trailing-counter',
            globals: {
              colorScheme: theme,
            },
          })
  ...
  test.describe('Trailing Visual', () => {
    for (const theme of themes) {
      test.describe(theme, () => {
        test('default @vrt', async ({page}) => {
          await visit(page, {
            id: 'drafts-components-button-features--trailing-visual',
            globals: {
              colorScheme: theme,
            },
          })
