...
const scenarios = matrix({
  ...
  story: [
    ...
    {id: 'components-selectpanel-features--as-multi-select-modal', name: 'As Multi Select Modal'},
    {id: 'components-selectpanel-features--as-single-select-modal', name: 'As Single Select Modal'},
    {
