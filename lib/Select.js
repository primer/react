...
const ArrowIndicator = styled__default["default"](ArrowIndicatorSVG).withConfig({
...
const Select = /*#__PURE__*/React__default["default"].forwardRef(({
  ...
  validationStatus,
  ...rest
}, ref) => /*#__PURE__*/React__default["default"].createElement(_TextInputWrapper["default"], {
  sx: {
    overflow: 'hidden',
    position: 'relative',
...
}, rest), placeholder && /*#__PURE__*/React__default["default"].createElement("option", {
  value: "",
  disabled: required,
  selected: true,
  hidden: required
}, placeholder), children), /*#__PURE__*/React__default["default"].createElement(ArrowIndicator, null)));

const Option = props => /*#__PURE__*/React__default["default"].createElement("option", props);

Option.displayName = "Option";

const OptGroup = props => /*#__PURE__*/React__default["default"].createElement("optgroup", props);
