...
function useOnSelectFiles(props) {
  ...
  return React.useCallback(function onSelectFiles(files) {
...
function useClickFileSelect(props) {
  ...
  const onInputChange = React.useCallback(function onChange() {
  ...
  React.useEffect(function createFileInputClickTarget() {
...
function useDropFileSelect(props) {
  ...
  const onDragLeave = React.useCallback(() => setIsDraggedOver(false), []);
  ...
  const dropTargetProps = React.useMemo(() => ({
    onDragEnter,
    onDragOver,
    onDragLeave,
...
exports.useClickFileSelect = useClickFileSelect;
exports.useDropFileSelect = useDropFileSelect;
exports.usePasteFileSelect = usePasteFileSelect;
exports.useUnifiedFileSelect = useUnifiedFileSelect;
