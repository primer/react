...
const useDynamicTextareaHeight = ({
  ...
  React.useLayoutEffect(() => {
    ...
    const lastCharacterCoords = characterCoordinates.getCharacterCoordinates(element, element.value.length); // The calculator gives us the distance from the top border to the bottom of the caret, including
