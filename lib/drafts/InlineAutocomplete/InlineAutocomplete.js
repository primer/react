...
const InlineAutocomplete = ({
  ...
  const input = /*#__PURE__*/React.cloneElement(externalInput, { ...forwardProps,
  ...
  return (
    ...
    }), /*#__PURE__*/React__default["default"].createElement(index["default"], null, /*#__PURE__*/React__default["default"].createElement("span", {
      "aria-live": "assertive",
      "aria-atomic": true,
      style: {
        clipPath: 'circle(0)',
