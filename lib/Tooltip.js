...
function Tooltip({
  ...
  const classes = classnames__default["default"](className, `tooltipped-${direction}`, align && `tooltipped-align-${align}-2`, noDelay && 'tooltipped-no-delay', wrap && 'tooltipped-multiline');
  return /*#__PURE__*/React__default["default"].createElement(TooltipBase, _extends({
    role: "tooltip",
    "aria-label": text
  }, rest, {
    className: classes
