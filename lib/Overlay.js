...
const StyledOverlay = styled__default["default"].div.withConfig({
  displayName: "Overlay__StyledOverlay",
  componentId: "sc-1mkyld6-0"
})(["background-color:", ";box-shadow:", ";position:absolute;min-width:192px;max-width:640px;height:", ";max-height:", ";width:", ";border-radius:12px;overflow:hidden;animation:overlay-appear ", "ms ", ";@keyframes overlay-appear{0%{opacity:0;}100%{opacity:1;}}visibility:var(--styled-overlay-visibility);:focus{outline:none;}@media (forced-colors:active){outline:solid 1px transparent;}", ";"], constants.get('colors.canvas.overlay'), constants.get('shadows.overlay.shadow'), props => heightMap[props.height || 'auto'], props => props.maxHeight && heightMap[props.maxHeight], props => widthMap[props.width || 'auto'], animationDuration, constants.get('animation.easeOutCubic'), sx["default"]);
...
const Overlay = /*#__PURE__*/React__default["default"].forwardRef(({
  ...
  }, /*#__PURE__*/React__default["default"].createElement(StyledOverlay, _extends({
    height: height,
    role: role
  }, rest, {
    ref: overlayRef,
