  ...
  return (
    <>
      ...
      <Checklist aria-describedby="alpha">
        <Checklist.Item checked={items.propsDocumented}>Component props are documented on <Link href="https://primer.style/react/">primer.style/react</Link>.</Checklist.Item>
      ...
      <Checklist aria-describedby="beta">
        ...
        <Checklist.Item checked={items.usageExamplesDocumented}>Common usage examples are documented on <Link href="https://primer.style/react/">primer.style/react</Link>.</Checklist.Item>
        <Checklist.Item checked={items.hasStorybookStories}>Common usage examples are documented in <Link href="https://primer.style/react/storybook">storybook</Link> stories.</Checklist.Item>
