...
Position components get `POSITION`, `LAYOUT` and `COMMON` system props. Read our [System Props](/components/system-props) doc page for a full list of available props.
