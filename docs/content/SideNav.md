...
```jsx live
<SideNav border maxWidth={360} aria-label="Main">
...
Give the link the `full` prop to spread child elements across the link, which is useful for status icons, labels, and the like.
...
<SideNav border maxWidth={360}>
  ...
  <SideNav border variant="lightweight" py={3} pl={6} backgroundColor="white">
    <SideNav.Link href="#url" selected>
