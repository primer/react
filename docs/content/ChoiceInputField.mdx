...
**Use [ChoiceFieldset](/ChoiceFieldset) to render a group of related checkbox or radio input fields.** This component is only meant to be used in the case that you're building a custom checkbox or radio that is not yet supported by Primer (For example: the color mode selection in [Appearance settings](https://github.com/settings/appearance))
