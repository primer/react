...
To show a count value as a trailing visual inside `Button`, pass a value to the `trailingVisualCount` prop. The counter will match the `variant` styles of the parent button.

```jsx live
<Button trailingVisualCount="1">Watch</Button>
```
