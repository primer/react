...
import {MegaphoneIcon, BellIcon, BellSlashIcon} from '@primer/octicons-react'
...
### Example: using an onSelect handler
...
### Example: With pre-selected choices
...
### Example: A visually hidden legend
...
### Example: With one disabled item
...
### Example: Items with a caption and a leading visual
...
<ChoiceFieldset
  ...
  validationResult="validChoice"
  selected={['all']}
>
  <ChoiceFieldset.Legend>Security</ChoiceFieldset.Legend>

  <ChoiceFieldset.List>
    <ChoiceFieldset.Item value="all">All repos</ChoiceFieldset.Item>
    <ChoiceFieldset.Item value="none">No repos</ChoiceFieldset.Item>
  </ChoiceFieldset.List>
