...
<>
  ...
  <Select id="grouped">
    <Select.Group label="GUI">
      <Select.Option value="figma">Figma</Select.Option>
    </Select.Group>
    <Select.Group label="Code">
      <Select.Option value="css">Primer CSS</Select.Option>
      <Select.Option value="prc">Primer React components</Select.Option>
      <Select.Option value="pvc">Primer ViewComponents</Select.Option>
    </Select.Group>
...
The `Select.Group` component accepts the same props as a native HTML [`<optgroup>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/optgroup).
