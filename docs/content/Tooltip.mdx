...
<PropsTable>
  ...
  <PropsTableRow name="noDelay" type="boolean" defaultValue={false} description={
    <>When set to <InlineCode>true</InlienCode>, tooltip appears without any delay</>
  } />
  <PropsTableRow name="wrap" deprecated type="boolean" description={
