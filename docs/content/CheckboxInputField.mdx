...
import {CheckboxInputField} from '@primer/react'
...
**Use [ChoiceFieldset](/ChoiceFieldset) to render a group of related checkbox input fields.** Do not use this component on its own unless you're rendering a single checkbox field on it's own, and there will never be related checkboxes.
