...
<PropsTable>
  ...
  <PropsTableRow
    name="variant"
    type="{
      narrowLandscape?: 'hideLabels' | 'dropdown' | 'none',
      narrow?: 'hideLabels' | 'dropdown' | 'none',
      regular?: 'hideLabels' | 'dropdown' | 'none',
      wide?: 'hideLabels' | 'dropdown' | 'none',
      portrait?: 'hideLabels' | 'dropdown' | 'none',
      landscape?: 'hideLabels' | 'dropdown' | 'none'
    }"
