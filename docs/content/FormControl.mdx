  ...
  return (
    <FormControl>
      ...
      {validationResult === 'noSpaces' && (
        <FormControl.Validation appearance="error">GitHub handles cannot contain spaces</FormControl.Validation>
      )}
      {validationResult === 'validName' && (
        <FormControl.Validation appearance="success">Valid name</FormControl.Validation>
      )}
