...
const WithIconAndLoadingIndicator = () => {
  ...
  return (
    <>
      ...
      <Box mb={3}>
        <TextInput leadingVisual={SearchIcon} isLoading={isLoading} />
      </Box>
      ...
      <Box mb={3}>
        <TextInput trailingVisual={SearchIcon} isLoading={isLoading} />
      </Box>
      ...
      <Box mb={3}>
        <TextInput leadingVisual={SearchIcon} trailingVisual={SearchIcon} isLoading={isLoading} />
      </Box>
...
/>
<PropsTableRow name="variant" type="'small' | 'medium' | 'large'" description="(Use size) Creates a smaller or larger input than the default." deprecated />
