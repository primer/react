...
```jsx live
<TextInput aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />
```
...
```jsx live
<>
  <TextInput leadingVisual={SearchIcon} aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />

  <TextInput trailingVisual={SearchIcon} aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />
</>
```
...
```jsx live
<>
  <TextInput leadingVisual="$" aria-label="Cost of the thing" name="cost" />
...
```jsx live
<>
  <TextInput validationStatus="error" aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />

  <TextInput validationStatus="warning" aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />
</>
```
...
```jsx live
<TextInput block aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />
```

### Contrast text input

```jsx live
<TextInput contrast aria-label="Zipcode" name="zipcode" autoComplete="postal-code" />
```

### Monospace text input

```jsx live
<TextInput monospace aria-label="personal access token" name="pat" leadingVisual={CheckIcon} />
```
