...
## Text Input with visuals and loading indicators
...
const WithIconAndLoadingIndicator = () => {
  ...
  return (
    <>
      ...
      <Box mb={2}>
        <TextInput leadingVisual={SearchIcon} isLoading={isLoading} value="auto" />
      </Box>
      <Box mb={2}>
        <TextInput leadingVisual={SearchIcon} isLoading={isLoading} loaderPosition="leading" value="leading" />
      </Box>
      <Box mb={5}>
        <TextInput leadingVisual={SearchIcon} isLoading={isLoading} loaderPosition="trailing" value="trailing" />
      </Box>

      <h3>Trailing visual</h3>
      <Box mb={2}>
        <TextInput trailingVisual={SearchIcon} isLoading={isLoading} value="auto" />
      </Box>
      <Box mb={2}>
        <TextInput trailingVisual={SearchIcon} isLoading={isLoading} loaderPosition="leading" value="leading" />
      </Box>
      <Box mb={5}>
        <TextInput trailingVisual={SearchIcon} isLoading={isLoading} loaderPosition="trailing" value="trailing" />
      </Box>
...
<PropsTable>
  ...
  />
  <PropsTableRow name="isLoading" type="boolean" description="Whether the to show a loading indicator in the input" />
  <PropsTableRow
    name="loaderPosition"
