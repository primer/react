...
| :----------------------------------------------------------------------------- | :-----: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Button props](https://github.com/primer/react/blob/main/src/Button2/types.ts) |    -    | Optional. You can pass all of the props that you would pass to a [`Button v2`](https://github.com/primer/react/blob/main/src/Button2/types.ts) component like `variant`, `leadingIcon`, `sx`, etc. |
