...
source: https://github.com/primer/react/tree/main/packages/react/src/experimental/InlineAutocomplete
storybook: '/react/storybook?path=/story/deprecated-components-inlineautocomplete--default'
---

import data from '../../../packages/react/src/experimental/InlineAutocomplete/InlineAutocomplete.docs.json'

```js
import {InlineAutocomplete} from '@primer/react/experimental'
```
...
```javascript live noinline experimental
