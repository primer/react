...
<DoDontContainer>
  <Do>Use ActionMenu to choose an action from a list.</Do>
  <Dont>
    <div>
      Don't use ActionMenu for single or multiple selection. Use <a href="/react/DropdownMenu">DropdownMenu</a> or{' '}
      <a href="/react/SelectPanel">SelectPanel</a> instead.
    </div>
  </Dont>
</DoDontContainer>
