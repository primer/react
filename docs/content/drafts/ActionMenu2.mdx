...
<DoDontContainer>
  <Do>Use ActionMenu to choose an action from a list of actions.</Do>
  <Dont>
    <div>
      Don't use ActionMenu with for single or multiple selection. Use <a href="/DropdownMenu">DropdownMenu</a> or{' '}
      <a href="/SelectPanel">SelectPanel</a> instead.
    </div>
  </Dont>
</DoDontContainer>
