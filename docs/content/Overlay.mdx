...
<PropsTable>
  ...
  <PropsTableRow
    ...
    type={
      <>
        <InlineCode>small</InlineCode>, <InlineCode>medium</InlineCode>, <InlineCode>large</InlineCode>,{' '}
        <InlineCode>xlarge</InlineCode>, <InlineCode>xxlarge</InlineCode>, <InlineCode>auto</InlineCode>
      </>
    }
    defaultValue="auto"
    description={
  ...
  <PropsTableRow
    ...
    type={
      <>
        <InlineCode>xsmall</InlineCode>, <InlineCode>small</InlineCode>, <InlineCode>medium</InlineCode>,{' '}
        <InlineCode>large</InlineCode>, <InlineCode>xlarge</InlineCode>, <InlineCode>auto</InlineCode>
      </>
    }
    defaultValue="auto"
    description={
  ...
  <PropsTableRow
    ...
    type={
      <>
        <InlineCode>visible</InlineCode>, <InlineCode>hidden</InlineCode>
      </>
    }
  ...
  <PropsTableRow
    ...
    type={
      <>
        <InlineCode>inside-top</InlineCode>, <InlineCode>inside-bottom</InlineCode>,{' '}
        <InlineCode>inside-left</InlineCode>, <InlineCode>inside-right</InlineCode>,{' '}
        <InlineCode>inside-center</InlineCode>, <InlineCode>outside-top</InlineCode>,{' '}
        <InlineCode>outside-bottom</InlineCode>, <InlineCode>outside-left</InlineCode>,{' '}
        <InlineCode>outside-right</InlineCode>
      </>
    }
    description={
