...
| (props: {isExpanded: boolean}) => React.ReactNode`}
  ...
  <PropsTableRow
    name="label"
    type="string"
    description="Provide an accessible name for the leading visual. This should provide information about what the visual indicates or represents"
  />
  {/* <PropsTableSxRow /> */}
</PropsTable>
...
| (props: {isExpanded: boolean}) => React.ReactNode`}
  ...
  <PropsTableRow
    name="label"
    type="string"
    description="Provide an accessible name for the trailing visual. This should provide information about what the visual indicates or represents"
  />
  {/* <PropsTableSxRow /> */}
</PropsTable>
