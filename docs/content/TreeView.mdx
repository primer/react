...
| (props: {isExpanded: boolean}) => React.ReactNode`}
  ...
  <PropsTableRow
    name="label"
    type="string"
    description="Optionally provide an accessible name for the leading visual if the visual is not decorative. This should provide information about what the visual indicates or represents"
  />
  {/* <PropsTableSxRow /> */}
</PropsTable>
...
| (props: {isExpanded: boolean}) => React.ReactNode`}
  ...
  <PropsTableRow
    name="label"
    type="string"
    description="Optionally provide an accessible name for the trailing visual if the visual is not decorative. This should provide information about what the visual indicates or represents"
  />
  {/* <PropsTableSxRow /> */}
</PropsTable>
