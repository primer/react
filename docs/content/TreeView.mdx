...
<PropsTable>
  <PropsTableRow name="children" type="React.ReactNode" required />
  {/* <PropsTableRow name="truncate" type="boolean" defaultValue="true" /> */}
  {/* TODO: We may need to provide a way to control the `expanded` state */}
  {/* <PropsTableRow name="defaultExpanded" type="boolean" defaultValue="false" /> */}
