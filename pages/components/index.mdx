...
This will set the `color`, `font-family`, and `line-height` CSS properties to the same ones used in [primer-base](https://github.com/primer/css/blob/master/src/base/base.scss#L15).
