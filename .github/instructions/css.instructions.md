...
3. Add a file-level stylelint-disable comment with justification: `/* stylelint-disable selector-pseudo-class-disallowed-list -- :has() scoped to CSS Module, audited for Safari perf (github/github-ui#17224) */`
