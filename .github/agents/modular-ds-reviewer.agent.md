...
- If the change reshapes an existing component to fit this model, whether the public API stayed identical and whether accessibility behavior that was previously implicit or untested now has test coverage.
