...
const colors = {
  ...
  red,
  yellow,
  blackfade15: rgba(black, 0.15),
  blackfade20: rgba(black, 0.20),
  whitefade15: rgba(white, 0.15)
}
...
const theme = {
  ...
  shadows: {
    small: `0 1px 1px ${rgba(colors.black, 0.1)}`,
    medium: `0 1px 5px ${colors.blackfade15}`,
    large: `0 1px 15px ${colors.blackfade15}`,
    'extra-large': `0 10px 50px ${rgba(colors.black, 0.07)}`
  },
  radii: [0, 3, 6],
