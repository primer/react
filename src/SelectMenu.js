...
const transformChildren = children => {
  return React.Children.map(children, child => {
    return React.cloneElement(child, {role: 'menuitem', className: `${child.props.className ? child.props.className + ' ' : ''}SelectMenu--list-item`})
  })
}

SelectMenu.List = styled.div.attrs(props => ({
