...
export const Default = {
  render: ({value: _value, checked, ...args}: FormControlArgs<CheckboxProps>) => {
...
export const Controlled = {
  render: (args: FormControlArgs<CheckboxProps>) => {
    const {parentArgs, labelArgs, captionArgs} = getFormControlArgsByChildComponent(args)
  ...
  parameters: {controls: {exclude: [...excludedControlKeys, 'checked']}},
