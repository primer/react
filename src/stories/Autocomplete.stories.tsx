...
export const Default = {
  render: (args: FormControlArgs<AutocompleteArgs>) => {
...
export const AddNewItem = {
  render: (args: FormControlArgs<AutocompleteArgs>) => {
    ...
    const onItemSelect: (item: Datum) => void = item => {
      onSelectedChange([
        ...selectedItemIds.map(id => items.find(selectedItem => selectedItem.id === id) as Datum),
        item,
      ])
...
export const AsyncLoadingOfItems = {
  ...
  parameters: {controls: {exclude: [...excludedControlKeys, 'loading']}},
}
