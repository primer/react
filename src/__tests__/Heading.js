...
it('Heading renders fontSize with f* classes using inverse scale', () => {
  expect(render(<Heading fontSize={0} />))
    .toEqual(render(<h1 className='m-0 f6' />))
  expect(render(<Heading fontSize={1} />))
    .toEqual(render(<h1 className='m-0 f5' />))
  expect(render(<Heading fontSize={2} />))
    .toEqual(render(<h1 className='m-0 f4' />))
  expect(render(<Heading fontSize={3} />))
    .toEqual(render(<h1 className='m-0 f3' />))
  expect(render(<Heading fontSize={4} />))
    .toEqual(render(<h1 className='m-0 f2' />))
  expect(render(<Heading fontSize={5} />))
    .toEqual(render(<h1 className='m-0 f1' />))
