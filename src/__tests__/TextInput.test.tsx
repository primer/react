...
describe('TextInput', () => {
  ...
  it('renders leadingVisual', () => {
    expect(render(<TextInput name="search" leadingVisual={SearchIcon} />)).toMatchSnapshot()
  })

  it('renders trailingVisual', () => {
    expect(render(<TextInput name="search" trailingVisual={SearchIcon} />)).toMatchSnapshot()
  })
  ...
  it('focuses the text input if you do not click the input element', () => {
    const {container, getByLabelText} = HTMLRender(
      <>
        ...
        <TextInput id="testInput" name="search" trailingVisual={SearchIcon} />
      </>
    )
