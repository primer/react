...
export {useConfirm} from './Dialogv2/ConfirmationDialog'
...
export type {ConfirmationDialogProps} from './Dialogv2/ConfirmationDialog'
export {ConfirmationDialog} from './Dialogv2/ConfirmationDialog'
